...
addHTMLElement('div', 'wanrning_could_not_enter_AR', 'TO', 'warning_center', false);
setHTMLElemAttribute('className', 'warning-could-not-enter-AR', 'wanrning_could_not_enter_AR', false);
addHTMLElement('img', 'wanrning_could_not_enter_AR_img', 'TO', 'wanrning_could_not_enter_AR', false);
setHTMLElemAttribute('src', 'media/warning_could_not_enter_AR.png', 'wanrning_could_not_enter_AR_img', false);
...
setHTMLElemAttribute('href', 'https://github.com/221voa16', 'info_button', false);
...
operateAnimation('PLAY', 'maria_armature', 0, 170, 'LoopRepeat', 1,
        function() {}, false);


volume(loadMedia_WebAudio('sounds/hello.mp3'), 0.5);
registerOnClick('maria_mesh', false, false, [0,1,2], function() {

  operateAnimation('STOP', 'maria_armature', null, null, 'AUTO', 1,
          function() {}, false);

      playSound(loadMedia_WebAudio('sounds/hello.mp3'), false);

  operateAnimation('PLAY', 'maria_armature', 171, 275, 'LoopOnce', 1,
          function() {
...
checkARMode(function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
    enterARMode('ORIGIN', true, function() {
      changeVis(['GROUP', 'maria_group'], false);
      ...
      changeVis(['GROUP', 'maria_group'], true);
      changeVis('prompt_move_around', false);
      setObjTransform('maria_armature', false, 'position', createVector(0, 0, 0), false);
      ...
      setObjTransform('maria_armature', false, 'scale', [1, 1, 1], false);
      updateTextObj('scale_percentage', '100%');
    }, function() {
      show_warning('wanrning_could_not_enter_AR');
    });
  });
}, function() {
  setHTMLElemAttribute('href', exportToUSDZ('maria_mesh'), 'enter_AR_button', false);
  setHTMLElemAttribute('rel', 'ar', 'enter_AR_button', false);
  setHTMLElemAttribute('download', 'maria.usdz', 'enter_AR_button', false);
}, function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
...
registerOnClick('indicator_invis_plane', false, false, [0,1,2], function() {
  changeVis(['GROUP', 'maria_group'], true);
  setObjTransform('maria_armature', false, 'position', [arHitPoint('x'), arHitPoint('y'), arHitPoint('z')], false);
  setObjDirection('maria_armature', getObjTransform('Camera', false, 'position', 'xyz'), true, true);
...
registerOnDrag('drag_move', false, [0,1,2], function() {}, function() {
  dragMoveAdv('maria_armature', 'XY', 'WORLD', '|y=cK@ydKIZW7:7*(OHH', 'xJ^`b.zsQ9VL[*!!~PDb');
}, function() {}, 'xJ^`b.zsQ9VL[*!!~PDb');

registerOnDrag('drag_rotate', false, [0,1,2], function() {}, function() {
  dragRotateAdv('maria_armature', 'Z', 'WORLD', 'imipg!Bp=YmgFGkt+!B?', 'NB-h?t2F3DA,JiZx=TVS');
}, function() {}, 'NB-h?t2F3DA,JiZx=TVS');

registerOnDrag('drag_scale', false, [0,1,2], function() {}, function() {
  dragScale('maria_armature', 'Z', 'OVFDpz%IcMkTdVP8Oc8P', '%[N-3E:G)$b97/$yD:J}');
  dragScale('maria_armature', 'Y', 'tK91Pj)l-hPk*#LHFD]`', '%[N-3E:G)$b97/$yD:J}');
  dragScale('maria_armature', 'X', '6v5w2Nv~]4NQ^];Wd8;J', '%[N-3E:G)$b97/$yD:J}');
  updateTextObj('scale_percentage', String(Math.round(toFixedPoint(getObjTransform('maria_armature', false, 'scale', 'z'), 2) * 100)) + '%');
}, function() {}, '%[N-3E:G)$b97/$yD:J}');
